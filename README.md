...
- Creative CSS effects (gradient text, animation, hover)
- Responsive mobile/desktop layout
- All HTML/CSS only
## 🎯 Goals
- Show off clean, creative front-end skills
- Demonstrate CSS effects like gradient text, hover scaling
